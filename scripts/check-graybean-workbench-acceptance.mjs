...
const checks = [
  ...
  ["director-desk-state", [node, "scripts/check-director-desk-state.mjs"]],
  ["director-desk-commands", [node, "scripts/check-director-desk-commands.mjs"]],
  ["director-desk-components", [node, "scripts/check-director-desk-components.mjs"]],
  ["director-desk-responsive", [node, "scripts/check-director-desk-responsive.mjs"]],
  ["director-desk-app-integration", [node, "scripts/check-director-desk-app-integration.mjs"]],
