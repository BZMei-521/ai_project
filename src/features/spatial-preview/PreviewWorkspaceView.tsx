...
export type PreviewWorkspaceViewProps = { scene: SpatialScene; selection?: string | null; projectAssetsDir?: string; onSceneChange: (scene: SpatialScene) => void; onSelectionChange: (id: string | null) => void };
export function PreviewWorkspaceView({ scene, selection = null, projectAssetsDir = "", onSceneChange, onSelectionChange }: PreviewWorkspaceViewProps): JSX.Element {
  return (
    <section data-stage-view="preview">
      <header><p>阶段 3</p><h1>空间预演</h1></header>
      <SpatialStageWorkbench projectAssetsDir={projectAssetsDir} />
