...
const impactSummary = buildStoryboardSummary(IMPACT_VALID, IMPACT_SCRIPT);
check(() => assert.equal(impactSummary.actions['E01-S01-B07'].impactEvidence.contactVisible, true));
